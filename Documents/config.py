"""
config.py — Configuration Module for SkillWallet GenAI

Manages environment variables, API keys, file paths,
...
def get_settings() -> Settings:
    """Return a Settings instance with loaded configuration."""
    return Settings()
