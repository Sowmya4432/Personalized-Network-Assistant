"""
test_topic_generator.py — Unit Tests for TopicGenerator Service

Tests the topic generation functionality including
topic creation, talking point generation, and prompt building.
"""
