"""
test_event_analyzer.py — Unit Tests for EventAnalyzer Service

Tests the event analysis functionality including
event parsing, theme extraction, and context building.
"""
