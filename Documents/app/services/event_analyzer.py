"""
event_analyzer.py — Event Analysis Service

Analyzes networking event details to extract context
such as event type, industry, audience profile, and key themes
using DistilBERT embeddings and cosine similarity.
"""
...
class EventAnalyzer:
    """Analyzes networking event metadata using DistilBERT embeddings."""
