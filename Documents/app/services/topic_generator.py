"""
topic_generator.py — Conversation Topic Generation Service

Generates personalized conversation topics and talking points
using GPT-2 Small based on event context and user profile.
"""
...
class TopicGenerator:
    """Generates contextual conversation topics using GPT-2."""

    def __init__(self):
        """Initialize the TopicGenerator with GPT-2 pipeline."""
    ...
    def _build_prompt(self, topic: str, event_context: dict = None) -> str:
        """Build the GPT-2 prompt from topic and event context."""
        event_name = (
    ...
    def _parse_talking_points(self, text: str, prompt: str, topic: str) -> list:
        """Parse GPT-2 output into structured talking points."""
    ...
    def _fallback_points(self, topic: str) -> list:
        """Return deterministic fallback talking points."""
        return [
            {
